/*
from: https://github.com/mauriciogentile/angular-livesearch
 */
'use strict';

import angular from 'angular';

export let liveSearchModule = angular.module("LiveSearch", ["ng"]);

liveSearchModule.directive("liveSearch", ["$compile", "$timeout", function ($compile, $timeout) {
    return {
        restrict: 'E',
        replace: true,
        scope: {
